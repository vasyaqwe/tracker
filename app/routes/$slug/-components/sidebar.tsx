      ...
      <aside className="sticky top-7 flex h-[375px] w-48 flex-col max-md:hidden">
            ...
            <ul className="before:-left-[2px] before:-top-[var(--block)] relative space-y-1 pl-1 [--block:2px] before:absolute before:h-[calc(100%+calc(var(--block)*2))] before:w-[2px] before:bg-border">
               <li>
                  <Link
                     ...
                     to={homeRoute.to}
                     className={cn(
                        "group before:-left-[6px] relative flex items-center gap-2 px-2 pb-2 font-medium leading-none transition-opacity duration-100 before:absolute before:h-5 before:w-[2px] before:rounded-sm before:bg-foreground hover:opacity-100",
                     )}
                  >
                     Home
                  </Link>
               ...
               <li>
                  <Link
                     ...
                     to={settingsRoute.to}
                     className={cn(
                        "group before:-left-[6px] relative flex items-center gap-2 px-2 pt-2 font-medium leading-none transition-opacity duration-100 before:absolute before:h-5 before:w-[2px] before:rounded-sm before:bg-foreground hover:opacity-100",
                     )}
                  >
                     Settings
                  </Link>
         ...
         <div className="mt-auto flex items-center gap-3">
            <Menu>
               ...
               <Menu.Content placement="top left">
